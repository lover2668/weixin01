...
Page({
  ...
  turnToPublish : function(event) {
    let franchiseeParam = this.data.franchisee ? ('&franchisee=' + this.data.franchisee) : '';
    app.turnToPage('/informationManagement/pages/communityPublishType/communityPublishType?detail=' + this.data.communityId + '&reqAudit=' + this.data.communityInfo.require_audit + '&from=communityPage' + franchiseeParam);
  },
