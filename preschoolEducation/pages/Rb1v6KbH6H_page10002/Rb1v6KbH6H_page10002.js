...
var pageData = {
  data: {
    "picture1": {
      "type": "picture",
      "style": "opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:494.53125rpx;width:750rpx;margin-left:auto;margin-right:auto;",
      "content": "http:\/\/img.weiye.me\/zcimgdir\/album\/file_58aea2a501bac.jpg",
      "customFeature": {
        "boxShadow": "5",
        "boxColor": "#000",
        "boxX": "0",
  ...
  need_login: false,
    page_router: 'Rb1v6KbH6H_page10002',
    page_form: 'none',
      list_compids_params: [],
