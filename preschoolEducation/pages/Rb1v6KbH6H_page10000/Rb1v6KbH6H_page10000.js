...
var pageData = {
  data: {
    "carousel1": {
      "type": "carousel",
      "style": "height:307.03125rpx;margin-left:0;margin-right:auto;opacity:1;",
      "content": [{
        "customFeature": [],
        "pic": "http:\/\/img.weiye.me\/zcimgdir\/album\/file_58ad5faf6a606.png",
        "content": "",
        "parentCompid": "carousel1",
        "style": ""
      }, {
        "customFeature": [],
        "pic": "http:\/\/img.weiye.me\/zcimgdir\/album\/file_58ad5f9ce6380.png",
        "content": "",
        "parentCompid": "carousel1",
        "style": ""
      }],
    ...
    "layout_vessel2": {
      "type": "layout-vessel",
      "style": "background-color:rgba(0, 0, 0, 0);opacity:1;min-height:auto;margin-left:auto;",
      "content": {
        "leftEles": [{
          "type": "title-ele",
          "style": "opacity:1;line-height:58.59375rpx;background-color:rgb(255, 255, 255);border-color:rgb(34, 34, 34);border-style:none;color:rgb(247, 146, 153);font-size:32.8125rpx;margin-left:auto;margin-right:auto;text-align:center;",
          "content": "\u70ed\u95e8\u6587\u7ae0",
          "customFeature": {
            "mode": 2,
            "markColor": "rgb(247, 146, 153)",
            "boxColor": "#000",
            "boxR": "5px",
            "boxStyle": false,
            "boxX": "0",
          ...
          "animations": [],
          "compId": "data.content.leftEles[0]",
          "parentCompid": "layout_vessel2",
          "markColor": "rgb(247, 146, 153)",
          "mode": 2
        }],
        "rightEles": [{
          "type": "title-ele",
          "style": "opacity:1;line-height:58.59375rpx;background-color:rgb(255, 255, 255);border-color:rgb(34, 34, 34);border-style:none;color:rgb(56, 42, 42);font-size:32.8125rpx;margin-left:auto;margin-right:auto;text-align:center;",
          "content": "\u70ed\u95e8\u5468\u8fb9",
          "customFeature": {
            "mode": "0",
            ...
            "boxY": "0",
            "action": "inner-link",
            "inner-page-link": "Rb1v6KbH6H_page10004"
          },
          "animations": [],
          "compId": "data.content.rightEles[0]",
          "parentCompid": "layout_vessel2",
          "markColor": "rgb(26, 147, 223)",
          "mode": 0,
          "itemType": "title-ele",
          "itemParentType": "layout-vessel",
          "itemIndex": 0,
          "eventParams": "{\"inner_page_link\":\"Rb1v6KbH6H_page10004\",\"is_redirect\":0}",
      ...
      "animations": [],
      "page_form": "",
      "compId": "layout_vessel2",
      "cell_style_1": "width:50%;margin-left:auto;",
      "cell_style_2": "width:50%;border-left-style:none;border-left-width:4.6875rpx;border-color:rgb(102, 102, 102);margin-left:auto;"
    },
    "breakline3": {
      "type": "breakline",
      "style": "border-width:2.34375rpx;border-bottom-style:solid;margin-left:0;margin-right;:auto;width:750rpx;border-bottom-color:rgb(239, 239, 239);",
      "content": "<div><\/div>",
      "customFeature": [],
      "animations": [],
      "page_form": "",
    ...
    "album4": {
      "style": "background-color:rgba(0, 0, 0, 0);color:rgb(56, 42, 42);font-size:28.125rpx;margin-top:11.71875rpx;opacity:1;text-align:center;margin-left:auto;",
      "ul_style": "padding-left:35.15625rpx;padding-top:23.4375rpx;margin-left:auto;",
      "html_mode": "sec-mode",
      "li": [{
        "customFeature": {
          "action": "inner-link",
          "page-link": "Rb1v6KbH6H_page10005"
        },
        "li_class": "album-pic router",
        "action": "inner-link",
        "pic": "http:\/\/img.weiye.me\/zcimgdir\/album\/file_58ad5fb1d320d.png",
        "title": "\u751f\u6d3b\u91cd\u7684\u8a00\u4f20\u8eab\u6559\uff0c\u5e2e\u52a9\u5b69\u5b50\u517b\u6210\u597d\u4e60\u60ef",
        "li_style": "width:679.6875rpx;margin-right:35.15625rpx;margin-bottom:23.4375rpx;margin-left:auto;",
        "img_style": "height:382.03125rpx;margin-left:auto;",
        "eventParams": "{\"inner_page_link\":\"Rb1v6KbH6H_page10005\",\"is_redirect\":0}",
        "eventHandler": "tapInnerLinkHandler"
      }, {
        "customFeature": {
          "action": "inner-link",
          "page-link": "Rb1v6KbH6H_page10006"
        },
        "li_class": "album-pic router",
        "action": "inner-link",
        "pic": "http:\/\/img.weiye.me\/zcimgdir\/thumb\/t_148775800258ad62b243a21.png",
        "title": "\u5982\u4f55\u57f9\u517b\u5b69\u5b50\u7684\u52a8\u624b\u80fd\u529b",
        "li_style": "width:679.6875rpx;margin-right:35.15625rpx;margin-bottom:23.4375rpx;margin-left:auto;",
        "img_style": "height:382.03125rpx;margin-left:auto;",
        "eventParams": "{\"inner_page_link\":\"Rb1v6KbH6H_page10006\",\"is_redirect\":0}",
        "eventHandler": "tapInnerLinkHandler"
      }, {
        "customFeature": {
          "action": "inner-link",
          "page-link": "Rb1v6KbH6H_page10007"
        },
        "li_class": "album-pic router",
        "action": "inner-link",
        "pic": "http:\/\/img.weiye.me\/zcimgdir\/thumb\/t_148775808758ad630757716.png",
        "title": "\u5c0f\u5b69\u65e9\u671f\u667a\u529b\u5f00\u53d1\u7684\u601d\u8003",
        "li_style": "width:679.6875rpx;margin-right:35.15625rpx;margin-bottom:23.4375rpx;margin-left:auto;",
        "img_style": "height:382.03125rpx;margin-left:auto;",
        "eventParams": "{\"inner_page_link\":\"Rb1v6KbH6H_page10007\",\"is_redirect\":0}",
        "eventHandler": "tapInnerLinkHandler"
      }],
      "customFeature": {
        "col": 1,
    ...
    need_login: false,
    page_router: 'Rb1v6KbH6H_page10000',
    page_form: 'none',
      list_compids_params: [],
